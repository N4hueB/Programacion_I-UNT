...
def mostrar_menu()->str:
    ...
    menu = '''
        ...
        9   - Determinar cual es el maximo de poder y mostrar los nombres de cuales heroes tienen un 
            poder inferior A LA MITAD DE PODER del heroe mas fuerte.
        10  - Salir 
        '''
    print(menu)